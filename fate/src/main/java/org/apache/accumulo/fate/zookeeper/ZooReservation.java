...
public class ZooReservation {
    ...
    public static boolean attempt(IZooReaderWriter zk, String path, String reservationID, String debugInfo)
    ...
    public static void release(IZooReaderWriter zk, String path, String reservationID)
        ...
        if (!idInZoo.equals(reservationID)) {
            throw new IllegalStateException(
                    "Tried to release reservation " + path + " with data mismatch " + reservationID + " " + zooDataStr);
        }

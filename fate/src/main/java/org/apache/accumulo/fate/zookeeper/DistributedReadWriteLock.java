    ...
    static class ReadLock implements Lock {
        ...
        public boolean tryLock() {
            if (entry == -1) {
                ...
                log.info("Added lock entry " + entry + " userData " + new String(this.userData, UTF_8) + " lockType "
                        + lockType());
            }
            ...
            throw new IllegalStateException("Did not find our own lock in the queue: " + this.entry + " userData "
                    + new String(this.userData, UTF_8) + " lockType " + lockType());
        }
        ...
        public void unlock() {
            if (entry == -1)
                return;
            log.debug("Removing lock entry " + entry + " userData " + new String(this.userData, UTF_8) + " lockType "
                    + lockType());

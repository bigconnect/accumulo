...
/**
 * Encapsulates the retrying implementation for some operation. Provides bounded retry attempts with a bounded, linear
 * backoff.
 */
public class Retry {
    ...
    private String getMessage(String message, Throwable t) {
        return message + ":" + t + ", retrying attempt " + (retriesDone + 1) + " (suppressing retry messages for "
                + getLogInterval() + "ms)";
    }
    ...
    public interface NeedsRetryDelay {
        /**
         * @param duration
         *            the amount of time to wait before the first retry; input is converted to milliseconds, rounded
         *            down to the nearest
         * 
    ...
    public interface NeedsTimeIncrement {
        /**
         * @param duration
         *            the amount of additional time to add before each subsequent retry; input is converted to
    ...
    public interface NeedsMaxWait {
        /**
         * @param duration
         *            the maximum amount of time to which the waiting period between retries can be incremented; input
         *            is converted to milliseconds, rounded down to the nearest
         * 
    ...
    public interface NeedsLogInterval {
        /**
         * @param duration
         *            the minimum time interval between logging that a retry is occurring; input is converted to
         *            milliseconds, rounded down to the nearest
         * 
    ...
    public interface BuilderDone {
        /**
         * Create a RetryFactory from this builder which can be used to create many Retry objects with the same
         * settings.
         *
         * @return this builder as a factory; intermediate references to this builder cannot be used to change options
    ...
    private static class RetryFactoryBuilder implements NeedsRetries, NeedsRetryDelay, NeedsTimeIncrement, NeedsMaxWait,
            NeedsLogInterval, BuilderDone, RetryFactory {
